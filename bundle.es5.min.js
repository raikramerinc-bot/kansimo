...
var Sentry = function(t) {
    ...
    function J() {
        ...
        return function(t, n) {
            ...
            var f = [];
            try {
                for (var c = i(t.split("\n").slice(n)), s = c.next(); !s.done; s = c.next()) {
                    var v = s.value;
                    if (!(v.length > 1024)) {
                        var h = v.replace(/\(error: (.*)\)/, "$1");
                        try {
                            for (var l = (u = void 0,
                            i(r)), d = l.next(); !d.done; d = l.next()) {
                                var y = (0,
                                d.value)(h);
                                if (y) {
                                    f.push(y);
        ...
        if (!rt[t])
            ...
            case "console":
                !function() {
                    if (!("console"in tt))
                        return;
                    N.forEach((function(t) {
                        t in tt.console && C(tt.console, t, (function(n) {
                            return function() {
            ...
            case "dom":
                !function() {
                    if (!("document"in tt))
                        return;
                    var t = ot.bind(null, "dom")
                      , n = st(t, !0);
                    tt.document.addEventListener("click", n, !1),
                    tt.document.addEventListener("keypress", n, !1),
                    ...
                    if (!function() {
                        ...
                        if (n && "function" == typeof n.createElement)
                            try {
                                ...
                                r.contentWindow && r.contentWindow.fetch && (t = Q(r.contentWindow.fetch)),
                                n.head.removeChild(r)
                            } catch (t) {}
                        return t
                    }())
                        return;
                    C(tt, "fetch", (function(t) {
                        return function() {
                            for (var n = [], r = 0; r < arguments.length; r++)
                                n[r] = arguments[r];
                            var i = {
                            ...
                            return ot("fetch", e({}, i)),
                            t.apply(tt, n).then((function(t) {
                                return ot("fetch", e(e({}, i), {
                                    endTimestamp: Date.now(),
                                    response: t
                                })),
                                t
                ...
                !function() {
                    if (!function() {
                        var t = V.chrome
                          ...
                          , r = "history"in V && !!V.history.pushState && !!V.history.replaceState;
                        return !n && r
                    }())
                        return;
                    var t = tt.onpopstate;
                    ...
                    ,
                    C(tt.history, "pushState", n),
                    C(tt.history, "replaceState", n)
                }();
                break;
            case "error":
                vt = tt.onerror,
                tt.onerror = function(t, n, r, e, i) {
                    return ot("error", {
                        column: e,
                        error: i,
                        line: r,
            ...
            case "unhandledrejection":
                lt = tt.onunhandledrejection,
                tt.onunhandledrejection = function(t) {
                    return ot("unhandledrejection", t),
    ...
    function ot(t, n) {
        ...
        if (t && nt[t])
            try {
                for (var o = i(nt[t] || []), u = o.next(); !u.done; u = o.next()) {
                    var a = u.value;
                    try {
                        a(n)
                    } catch (t) {}
    ...
    function ut(t) {
        return void 0 === t && (t = []),
        "Request"in tt && m(t[0], Request) && t[0].method ? String(t[0].method).toUpperCase() : t[1] && t[1].method ? String(t[1].method).toUpperCase() : "GET"
    }
    function at(t) {
        return void 0 === t && (t = []),
        "string" == typeof t[0] ? t[0] : "Request"in tt && m(t[0], Request) ? t[0].url : String(t[0])
    }
    var ft, ct;
    function st(t, n) {
        return void 0 === n && (n = !1),
        function(r) {
            if (r && ct !== r && !function(t) {
                if ("keypress" !== t.type)
                    return !1;
                try {
                    var n = t.target;
    ...
    function _t(t, n, r) {
        ...
        }(JSON.stringify(e)) > r ? _t(t, n - 1, r) : i
    }
    ...
    var xt = function() {
        function t(t) {
            ...
            ,
            this.v = function(t, r) {
                n.i === ht.PENDING && (p(r) ? r.then(n.u, n.h) : (n.i = t,
                n.l = r,
                n.p()))
            }
            ,
            this.p = function() {
                if (n.i !== ht.PENDING) {
                    ...
                    n.o = [],
                    t.forEach((function(t) {
                        t[0] || (n.i === ht.RESOLVED && t[1](n.l),
                        n.i === ht.REJECTED && t[2](n.l),
                        t[0] = !0)
                    }
                    ))
                }
        ...
        return {
            ...
            add: function(e) {
                if (!(void 0 === t || n.length < t))
                    return St(new S("Not adding Promise because buffer limit was reached."));
                var i = e();
    ...
    function Pt(t, n) {
        ...
        function s(t) {
            "string" == typeof c ? c = "string" == typeof t ? c + t : [Ht(c, n), t] : c.push("string" == typeof t ? Ht(t, n) : t)
        }
        try {
    ...
    function Xt(t, n) {
        var r = "string" == typeof t.data ? Ht(t.data, n) : t.data;
        return [W({
            type: "attachment",
            length: r.length,
            filename: t.filename,
    ...
    var Gt = function() {
        ...
        t.prototype.setTag = function(t, n) {
            var r;
            return this.O = e(e({}, this.O), ((r = {})[t] = n,
            r)),
            this.q(),
            this
        }
        ...
        t.prototype.setContext = function(t, n) {
            return null === n ? delete this.T[t] : this.T[t] = n,
            this.q(),
            this
        }
        ,
        ...
        t.prototype.setSession = function(t) {
            return t ? this.I = t : delete this.I,
            this.q(),
            this
        }
        ,
        ...
        t.prototype.update = function(n) {
            ...
            return n instanceof t ? (this.O = e(e({}, this.O), n.O),
            this.R = e(e({}, this.R), n.R),
            this.T = e(e({}, this.T), n.T),
            n.S && Object.keys(n.S).length && (this.S = n.S),
            n.N && (this.N = n.N),
            n.L && (this.L = n.L),
            n.C && (this.C = n.C)) : d(n) && (n = n,
            this.O = e(e({}, this.O), n.tags),
            this.R = e(e({}, this.R), n.extra),
            this.T = e(e({}, this.T), n.contexts),
            n.user && (this.S = n.user),
            n.level && (this.N = n.level),
            n.fingerprint && (this.L = n.fingerprint),
        ...
        t.prototype.addBreadcrumb = function(t, n) {
            ...
            return this.j = u(this.j, [i]).slice(-r),
            this.q(),
            this
        }
        ,
        ...
        t.prototype.applyToEvent = function(t, n) {
            if (void 0 === n && (n = {}),
            this.R && Object.keys(this.R).length && (t.extra = e(e({}, this.R), t.extra)),
            this.O && Object.keys(this.O).length && (t.tags = e(e({}, this.O), t.tags)),
            this.S && Object.keys(this.S).length && (t.user = e(e({}, this.S), t.user)),
            this.T && Object.keys(this.T).length && (t.contexts = e(e({}, this.T), t.contexts)),
            ...
            this.A) {
                ...
                var r = this.A.transaction && this.A.transaction.name;
                r && (t.tags = e({
                    transaction: r
                }, t.tags))
            }
            return this.U(t),
            t.breadcrumbs = u(t.breadcrumbs || [], this.j),
            t.breadcrumbs = t.breadcrumbs.length > 0 ? t.breadcrumbs : void 0,
            t.sdkProcessingMetadata = e(e({}, t.sdkProcessingMetadata), this.D),
            this.H(u(Kt(), this._), t, n)
        }
        ,
        t.prototype.setSDKProcessingMetadata = function(t) {
            return this.D = e(e({}, this.D), t),
            this
        }
        ,
        t.prototype.H = function(t, n, r, i) {
            ...
            new xt((function(u, a) {
                ...
                if (null === n || "function" != typeof f)
                    ...
                    )).then(null, a) : o.H(t, c, r, i + 1).then(u).then(null, a)
                }
            }
            ))
        }
        ...
        t.prototype.U = function(t) {
            t.fingerprint = t.fingerprint ? wt(t.fingerprint) : [],
    ...
    var Yt = function() {
        ...
        t.prototype.captureException = function(t, n) {
            var r = this.F = n && n.event_id ? n.event_id : dt()
              , i = new Error("Sentry syntheticException");
            return this.W((function(o, u) {
        ...
        t.prototype.captureMessage = function(t, n, r) {
            var i = this.F = r && r.event_id ? r.event_id : dt()
              , o = new Error(t);
            return this.W((function(u, a) {
        ...
        t.prototype.captureEvent = function(t, n) {
            var r = n && n.event_id ? n.event_id : dt();
            return t.type || (this.F = r),
            this.W((function(i, o) {
    ...
    function tn() {
        var t, n = Qt();
        return (t = n) && t.__SENTRY__ && t.__SENTRY__.hub && !nn(n).isOlderThan(4) || rn(n, new Yt),
        nn(n)
    }
    function nn(t) {
    ...
    function an(t, n) {
        ...
        var r = "string" == typeof n ? n : n.tunnel
          , e = "string" != typeof n && n.G ? n.G.sdk : void 0;
        return r || function(t) {
            return "" + on(t) + t.projectId + "/envelope/"
        }(t) + "?" + un(t, e)
    }
    function fn(t, n, r, i) {
        var o = Wt(r)
    ...
    function sn(t) {
        ...
        var e = function(t) {
            ...
            Object.values(n)
        }(Array.isArray(r) ? u(n, r) : "function" == typeof r ? wt(r(n)) : n)
    ...
    function vn(t, n) {
        n[t.name] = t,
        -1 === cn.indexOf(t.name) && (t.setupOnce(Vt, tn),
        cn.push(t.name))
    }
    function hn(t, n, r, i) {
        var o = t.normalizeDepth
          ...
          , c = void 0 === f ? 1e3 : f
          , s = e(e({}, n), {
            event_id: n.event_id || r.event_id || dt(),
        ...
        }(s, t.integrations.map((function(t) {
            return t.name
        }
        )));
        var v = i;
        r.captureContext && (v = Gt.clone(v).update(r.captureContext));
        var h = kt(s);
        if (v) {
            if (v.getAttachments) {
                var l = u(r.attachments || [], v.getAttachments());
                l.length && (r.attachments = l)
            }
            h = v.applyToEvent(s, r)
        }
        return h.then((function(t) {
            return "number" == typeof a && a > 0 ? function(t, n, r) {
                ...
                var i = e(e(e(e(e({}, t), t.breadcrumbs && {
                    ...
                    contexts: Et(t.contexts, n, r)
                }), t.extra && {
                    extra: Et(t.extra, n, r)
                });
                t.contexts && t.contexts.trace && i.contexts && (i.contexts.trace = t.contexts.trace,
                t.contexts.trace.data && (i.contexts.trace.data = Et(t.contexts.trace.data, n, r)));
                t.spans && (i.spans = t.spans.map((function(t) {
                    return t.data && (t.data = Et(t.data, n, r)),
                    t
                }
                )));
                return i
    ...
    var ln = function() {
        ...
        t.prototype.captureEvent = function(t, n, r) {
            if (!(n && n.originalException && gt(n.originalException))) {
                var e = n && n.event_id;
        ...
        t.prototype.setupIntegrations = function() {
            var t, n;
            this._isEnabled() && !this.V && (this.K = (t = this.tt.integrations,
            n = {},
            t.forEach((function(t) {
                vn(t, n)
            }
        ...
        t.prototype.sendEvent = function(t, n) {
            ...
            if (void 0 === n && (n = {}),
            this.nt) {
                var o = fn(t, this.nt, this.tt.G, this.tt.tunnel);
                try {
                    for (var u = i(n.attachments || []), a = u.next(); !a.done; a = u.next()) {
                        o = qt(o, Xt(a.value, this.tt.transportOptions && this.tt.transportOptions.textEncoder))
                    }
                } catch (t) {
                    r = {
                        error: t
        ...
        t.prototype.sendSession = function(t) {
            if (this.nt) {
                ...
                }(t, this.nt, this.tt.G, this.tt.tunnel);
                this.ut(n)
            }
        }
        ,
        ...
        t.prototype.ct = function(t, n, r) {
            return hn(this.getOptions(), t, n, r)
        }
        ,
        ...
        t.prototype.st = function(t, n, r) {
            var i = this
              ...
              , a = o.sampleRate;
            if (!this._isEnabled())
                return St(new S("SDK not enabled, will not capture event.","log"));
            var f = yn(t)
              , c = dn(t)
              , s = t.type || "error"
              , v = "before send for type `" + s + "`";
            if (c && "number" == typeof a && Math.random() > a)
                return this.recordDroppedEvent("sample_rate", "error", t),
                St(new S("Discarding event because it's not included in the random sample (sampling rate = " + a + ")","log"));
            var h = "replay_event" === s ? "replay" : s;
            return this.ct(t, n, r).then((function(r) {
                if (null === r)
                    throw i.recordDroppedEvent("event_processor", h, t),
                ...
                if (null === o)
                    throw i.recordDroppedEvent("before_send", h, t),
                    new S(v + " returned `null`, will not send event.","log");
                var a = r && r.getSession();
                !f && a && i.ft(a, o);
                var c = o.transaction_info;
                if (f && c && o.transaction !== t.transaction) {
                    var s = "custom";
                    o.transaction_info = e(e({}, c), {
                        source: s,
                        changes: u(c.changes, [{
                            source: s,
    ...
    function pn(t, n, r) {
        void 0 === r && (r = Ot(t.bufferSize || 30));
        var e = {};
        return {
            send: function(i) {
                var o = [];
                if (Ut(i, (function(n, r) {
                    var i, u, a, f = Ft(r);
                    if (i = e,
                    u = f,
                    void 0 === a && (a = Date.now()),
                ...
                var u = Ct(i[0], o)
                  , a = function(n) {
                    Ut(u, (function(r, e) {
                        var i = mn(r, e);
                        t.recordDroppedEvent(n, Ft(e), i)
                    }
                    ))
                };
                return r.add((function() {
                    return n({
                        body: Pt(u, t.textEncoder)
                    }).then((function(t) {
                        return e = Bt(e, t),
                        t
                    }
    ...
    var bn, gn = "7.32.0", wn = function() {
        ...
        t
    }(), En = [/^Script error\.?$/, /^Javascript error: Script error\.? on line 0$/], _n = function() {
        function t(n) {
            void 0 === n && (n = {}),
            this.tt = n,
            this.name = t.id
                        ...
                        var o = e.getClient()
                          ...
                          , f = function(t, n) {
                            ...
                            return {
                                ...
                                ignoreErrors: u(t.ignoreErrors || [], n.ignoreErrors || [], En),
            ...
            try {
                ...
                en((function(r) {
                    r.addEventProcessor((function(t) {
                        return n.mechanism && (mt(t, void 0, void 0),
                        bt(t, n.mechanism)),
                        t.extra = e(e({}, t.extra), {
                            arguments: i
                        }),
    ...
    function Ln(t, n, r, e) {
        var i = qn(t, n, r && r.syntheticException || void 0, e);
        return bt(i),
        i.level = "error",
    ...
    function Cn(t, n, r, e, i) {
        void 0 === r && (r = "info");
        var o = Un(t, n, e && e.syntheticException || void 0, i);
        return o.level = r,
        e && e.event_id && (o.event_id = e.event_id),
        kt(o)
    }
    function qn(t, n, r, i, o) {
        var u;
        if (s(n) && n.error)
            return Nn(t, n.error);
        ...
        return f(n) ? Nn(t, n) : d(n) || y(n) ? (u = function(t, n, r, e) {
            var i = tn().getClient()
    ...
    var Hn = 1024
      ...
      , Xn = function() {
        ...
        return t.prototype.setupOnce = function() {
            this.options.console && it("console", $n),
            this.options.dom && it("dom", function(t) {
                function n(n) {
            ...
            this.options.xhr && it("xhr", Fn),
            this.options.fetch && it("fetch", Wn),
            this.options.history && it("history", Bn)
        }
        ,
        t.prototype.addSentryBreadcrumb = function(t) {
            this.options.sentry && tn().addBreadcrumb({
    ...
    function $n(t) {
        ...
        var r, e = {
            ...
            level: (r = t.level,
            "warn" === r ? "warning" : Tt.includes(r) ? r : "log"),
            message: I(t.args, " ")
        };
        if ("assert" === t.level) {
            if (!1 !== t.args[0])
    ...
    function Wn(t) {
        t.endTimestamp && (t.fetchData.url.match(/sentry_key/) && "POST" === t.fetchData.method || (t.error ? tn().addBreadcrumb({
            category: "fetch",
            data: t.fetchData,
            level: "error",
            type: "http"
    ...
    var Jn = function(t) {
        function n(n) {
            ...
            n.sendClientReports && Sn.document && Sn.document.addEventListener("visibilitychange", (function() {
                "hidden" === Sn.document.visibilityState && r.ht()
            }
            )),
            r
        }
        ...
        n.prototype.eventFromException = function(t, n) {
            return Ln(this.tt.stackParser, t, n, this.tt.attachStacktrace)
        }
        ,
        n.prototype.eventFromMessage = function(t, n, r) {
            return void 0 === n && (n = "info"),
            Cn(this.tt.stackParser, t, n, r, this.tt.attachStacktrace)
        }
        ,
        n.prototype.sendEvent = function(n, r) {
            var e = this.getIntegrationById(Pn);
        ...
        n.prototype.ht = function() {
            ...
            if (0 !== t.length && this.nt) {
                var n, r, e, i = an(this.nt, this.tt), o = (n = t,
                Ct((r = this.tt.tunnel && O(this.nt)) ? {
                    dsn: r
                } : {}, [[{
                    type: "client_report"
                }, {
                ...
                try {
                    if ("[object Navigator]" === Object.prototype.toString.call(Sn && Sn.navigator) && "function" == typeof Sn.navigator.sendBeacon && !this.tt.transportOptions)
                        Sn.navigator.sendBeacon.bind(Sn.navigator)(i, Pt(o));
                    else
                        this.ut(o)
                } catch (t) {}
            }
    ...
    var Qn = /^\s*at (?:(.*\).*?|.*?) ?\((?:address at )?)?((?:file|https?|blob|chrome-extension|address|native|eval|webpack|<anonymous>|[-a-z]+:|.*bundle|\/)?.*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i
      , Zn = /\((\S*)(?::(\d+))(?::(\d+))\)/
      , tr = [30, function(t) {
        var n = Qn.exec(t);
        if (n) {
            ...
            var e = o(hr(n[1] || Vn, n[2]), 2)
              , i = e[0];
            return Yn(e[1], i, n[3] ? +n[3] : void 0, n[4] ? +n[4] : void 0)
        }
    }
    ]
      , nr = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:file|https?|blob|chrome|webpack|resource|moz-extension|safari-extension|safari-web-extension|capacitor)?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js)|\/[\w\-. /=]+)(?::(\d+))?(?::(\d+))?\s*$/i
      ...
      , er = [50, function(t) {
        ...
        if (r) {
            ...
            var i = r[3]
              , u = r[1] || Vn;
            return u = (n = o(hr(u, i), 2))[0],
            Yn(i = n[1], u, r[4] ? +r[4] : void 0, r[5] ? +r[5] : void 0)
        }
    }
    ]
      , ir = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx|https?|webpack|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i
      , or = [40, function(t) {
        var n = ir.exec(t);
        return n ? Yn(n[2], n[1] || Vn, +n[3], n[4] ? +n[4] : void 0) : void 0
    }
    ]
      , ur = / line (\d+).*script (?:in )?(\S+)(?:: in function (\S+))?$/i
      , ar = [10, function(t) {
        var n = ur.exec(t);
        return n ? Yn(n[2], n[3] || Vn, +n[1]) : void 0
    }
    ]
      , fr = / line (\d+), column (\d+)\s*(?:in (?:<anonymous function: ([^>]+)>|([^)]+))\(.*\))? in (.*):\s*$/i
      , cr = [20, function(t) {
        var n = fr.exec(t);
        return n ? Yn(n[5], n[3] || n[4] || Vn, +n[1], +n[2]) : void 0
    }
    ]
      , sr = [tr, er, or]
      , vr = J.apply(void 0, u(sr))
      , hr = function(t, n) {
        var r = -1 !== t.indexOf("safari-extension")
          , e = -1 !== t.indexOf("safari-web-extension");
        return r || e ? [-1 !== t.indexOf("@") ? t.split("@")[0] : Vn, r ? "safari-extension:" + n : "safari-web-extension:" + n] : [t, n]
    }
      , lr = function() {
        function t(n) {
            this.name = t.id,
    ...
    function dr() {
        it("error", (function(t) {
            var n = o(br(), 3)
              ...
              , e = n[1]
              , i = n[2];
            if (r.getIntegration(lr)) {
                var u = t.msg
                  , a = t.url
                  , f = t.line
                  , c = t.column
                  , v = t.error;
                if (!(On() || v && v.__sentry_own_request__)) {
                    ...
                    }(u, a, f, c) : pr(qn(e, v || u, void 0, i, !1), a, f, c);
                    l.level = "error",
                    mr(r, v, l, "onerror")
                }
            }
    ...
    function yr() {
        it("unhandledrejection", (function(t) {
            var n = o(br(), 3)
              , r = n[0]
              , e = n[1]
              , i = n[2];
            if (r.getIntegration(lr)) {
                ...
                if (On() || u && u.__sentry_own_request__)
                    return !0;
                var a = l(u) ? {
                    exception: {
                        values: [{
    ...
    var gr = ["EventTarget", "Window", "Node", "ApplicationCache", "AudioTrackList", "ChannelMergerNode", "CryptoOperation", "EventSource", "FileReader", "HTMLUnknownElement", "IDBDatabase", "IDBRequest", "IDBTransaction", "KeyOperation", "MediaController", "MessagePort", "ModalWindow", "Notification", "SVGElementInstance", "Screen", "TextTrack", "TextTrackCue", "TextTrackList", "WebSocket", "WebSocketWorker", "Worker", "XMLHttpRequest", "XMLHttpRequestEventTarget", "XMLHttpRequestUpload"]
      , wr = function() {
        function t(n) {
            this.name = t.id,
            this.tt = e({
        ...
        return t.prototype.setupOnce = function() {
            this.tt.setTimeout && C(Sn, "setTimeout", Er),
            this.tt.setInterval && C(Sn, "setInterval", Er),
            this.tt.requestAnimationFrame && C(Sn, "requestAnimationFrame", _r),
            this.tt.XMLHttpRequest && "XMLHttpRequest"in Sn && C(XMLHttpRequest.prototype, "send", jr);
            var t = this.tt.eventTarget;
            t && (Array.isArray(t) ? t : gr).forEach(kr)
        }
        ,
        t.id = "TryCatch",
        t
    ...
    function kr(t) {
        ...
        r && r.hasOwnProperty && r.hasOwnProperty("addEventListener") && (C(r, "addEventListener", (function(n) {
            return function(r, e, i) {
                try {
                    "function" == typeof e.handleEvent && (e.handleEvent = Tn(e.handleEvent, {
                        mechanism: {
                            data: {
    ...
    function xr(t, n, r, e, i) {
        if (void 0 === i && (i = []),
        !m(r[e], Error) || i.length + 1 >= n)
            return i;
        var o = Dn(t, r[e]);
        return xr(t, n, r[e], e, u([o], i))
    }
    var Or = function() {
        function t() {
            this.name = t.id
        ...
        return t.prototype.setupOnce = function() {
            Vt((function(n) {
                if (tn().getIntegration(t)) {
                    if (!Sn.navigator && !Sn.location && !Sn.document)
                        return n;
                    var r = n.request && n.request.url || Sn.location && Sn.location.href
                      , i = (Sn.document || {}).referrer
                      , o = (Sn.navigator || {}).userAgent
    ...
    var Ir = Object.freeze({
      ...
      , Mr = [new _n, new wn, new wr, new Xn, new lr, new Sr, new Rr, new Or];
    function Lr(t) {
        t.startSession({
            ignoreDuration: !0
        }),
    ...
    var Cr = {};
    Sn.Sentry && Sn.Sentry.Integrations && (Cr = Sn.Sentry.Integrations);
    var qr = e(e(e({}, Cr), kn), Ir);
    return t.Breadcrumbs = Xn,
    t.BrowserClient = Jn,
    t.Dedupe = Rr,
    t.FunctionToString = wn,
    t.GlobalHandlers = lr,
    t.HttpContext = Or,
    t.Hub = Yt,
    t.InboundFilters = _n,
    ...
    t.captureMessage = function(t, n) {
        ...
        return tn().captureMessage(t, r, e)
    }
    ,
    t.chromeStackLineParser = tr,
    t.close = function(t) {
        var n = tn().getClient();
        return n ? n.close(t) : kt(!1)
    }
    ,
    ...
    ,
    t.createTransport = pn,
    t.defaultIntegrations = Mr,
    t.defaultStackLineParsers = sr,
    t.defaultStackParser = vr,
    t.eventFromException = Ln,
    t.eventFromMessage = Cn,
    t.flush = function(t) {
        var n = tn().getClient();
        return n ? n.flush(t) : kt(!1)
    }
    ,
    t.forceLoad = function() {}
    ,
    t.geckoStackLineParser = er,
    t.getCurrentHub = tn,
    t.getHubFromCarrier = nn,
    t.init = function(t) {
        void 0 === t && (t = {}),
        void 0 === t.defaultIntegrations && (t.defaultIntegrations = Mr),
        void 0 === t.release && ("string" == typeof __SENTRY_RELEASE__ && (t.release = __SENTRY_RELEASE__),
        Sn.SENTRY_RELEASE && Sn.SENTRY_RELEASE.id && (t.release = Sn.SENTRY_RELEASE.id)),
        void 0 === t.autoSessionTracking && (t.autoSessionTracking = !0),
        void 0 === t.sendClientReports && (t.sendClientReports = !0);
        var n, r = e(e({}, t), {
            stackParser: (n = t.stackParser || vr,
            Array.isArray(n) ? J.apply(void 0, u(n)) : n),
            integrations: sn(t),
            transport: t.transport || (Y() ? Gn : Kn)
        });
        !function(t, n) {
        ...
        t.autoSessionTracking && function() {
            if (void 0 === Sn.document)
                return;
            var t = tn();
            if (!t.captureSession)
                return;
            Lr(t),
            it("history", (function(t) {
                var n = t.from
                  , r = t.to;
                void 0 !== n && n !== r && Lr(tn())
            }
    ...
    ,
    t.opera10StackLineParser = ar,
    t.opera11StackLineParser = cr,
    ...
    t.showReportDialog = function(t, n) {
        ...
        Sn.document) {
            ...
            if (u) {
                ...
                var a = Sn.document.createElement("script");
                a.async = !0,
                a.src = function(t, n) {
                    var r = T(t)
                      , e = on(r) + "embed/error-page/"
                      , i = "dsn=" + O(r);
                    for (var o in n)
                        if ("dsn" !== o)
                            if ("user" === o) {
                ...
                var f = Sn.document.head || Sn.document.body;
                f && f.appendChild(a)
            }
        }
    }
    ...
    t.startTransaction = function(t, n) {
        return tn().startTransaction(e({}, t), n)
    }
    ,
    t.winjsStackLineParser = or,
    t.withScope = en,
    t.wrap = function(t) {
        return Tn(t)()
    }
